...
// const randomNumberPractice = Math.random() * 55;
// console.log(randomNumberPractice);
// console.log(Math.ceil(randomNumberPractice));
// console.log(Math.round(randomNumberPractice));
// console.log(Math.floor(randomNumberPractice));
